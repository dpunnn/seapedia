          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              <div style={{
                ...
                <div>
                  <div style={{ fontSize: 14, fontWeight: 700, color: '#0F172A' }}>Produk Aktif</div>
                  <div style={{ fontSize: 12, color: '#94A3B8', marginTop: 2 }}>
                    Produk tidak aktif tidak akan tampil di toko
                  </div>
                </div>
                <button
                  type="button"
                  ...
                  style={{
                    ...
                    background: form.isActive ? 'linear-gradient(135deg,#1D4ED8,#2563EB)' : '#CBD5E1',
